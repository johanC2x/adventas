...
function guardarFactura($productos,$idtipodoc,$idprov,$idemp,$numfact,$subtotal,$igv,$total,$estado){
	$con = new clsConexion;
	if($con->conectarse()==true){
		$query="CALL SP_I_Compra($idtipodoc,$idprov,$idemp,'$numfact',now(),$subtotal,$igv,$total,'$estado')";
