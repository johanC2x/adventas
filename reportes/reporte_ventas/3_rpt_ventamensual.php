...
<table width="100%" border="0">
    ...
    <tr>
    	<td align="center"><input name="txtTotal" type="text" disabled id="textfield" class="input_text1" value="<?php echo "S/. ".number_format($tot_venta, 2, '.', ''); ?>" size="15" style="background-color:#FFC; color:#090"></td>
    </tr>
    <tr>
      <td align="center">&nbsp;</td>
    </tr>
