...
while($row=mysql_fetch_array($result)){
	...
	echo "<td align='center'>S/. ".$row['Costo']."</td>";
	echo "<td align='center'>S/. ".$row['Precio']."</td>";
	echo "<td align='center'>".$row['Cantidad']."</td>";
	echo "<td align='center'>S/. ".$row['Total']."</td>";
	echo "<td align='center'>S/. ".$row['Ganancia']."</td>";
	echo "</tr>";
...
<table width="100%" border="0">
    ...
    <tr>
        ...
        <td align="center"><input name="txtTotal" type="text" disabled id="textfield" class="input_text" value="<?php echo "S/. ".number_format($tot_venta, 2, '.', ''); ?>" size="10" style="background-color:#FFC"></td>
        <td align="center">
              <input name="txtGanancia" type="text" disabled id="textfield4" class="input_text" value="<?php echo "S/. ".number_format($tot_ganancia, 2, '.', ''); ?>" size="10" style="background-color: #DFF; ">
        </td>
    </tr>
</table>
