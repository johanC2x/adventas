...
//			$id_emp=$_GET['txtIdEmp'];
			...
			$estado="EMITIDO";
       		...
       		$productoDAO = new clsCompra();
			$facnum = $productoDAO->guardarFactura($carrito->productos,$id_tipodoc,$id_prov,$id_emp,$num_compra,$carrito->calcularValorCompra(),$carrito->calcularIgv(),$carrito->calcularTotalPagar(),$estado);
...
?>
    ...
    ?>
            ...
            <td width="20" align="center">S/.<?php echo $producto->costpro ;?></td>
            <td width="20"align="center">S/.<?php echo $producto->precioTotal() ;?></td>
	...
	<br>
<center><input type="button" value="Limpiar" class="btn_operaciones" style="width:130px;" onClick="parent:location='index.php?action=vacear'"/>
...
<!--<input type="button" value="Grabar" class="btn_operaciones" style="width: 130px" onClick="parent:location='index.php?action=guardar';">-->
     <?php
     	...
     	echo "<div class='box-info'>No tiene ningun producto en la orden de Compra</div>";
     ?>
...
<table width="100%" border="0">
  <tr>
    <td width="32%"><div class="total_venta" style="font-size:35px"><center><?php echo 'S/. '.number_format($carrito->calcularTotalPagar(), 2, '.', ','); ?></center></div></td>
  </tr>
  <tr>
    <td>
      <div class="box_1">
        <table width="271" border="0">
          ...
          <tr>
            <td align="center">&nbsp;</td>
            <td align="center">
              <input name="txtNumCompra" type="text" id="textfield4" value="<?php echo $num_compra ?>" size="41" style="text-align:center">
              </td>
            <td align="center">&nbsp;</td>
            </tr>
          </table>
      ...
      <div class="box_1">
        <table width="100%" border="0">
          ...
          <tr>
            <td><input type="hidden" name="txtIdProveedor" value="<?php echo $idproveedor ?>"><input name="txtNomProv" type="text" disabled size="35" value="<?php echo $nomproveedor ?>">&nbsp;&nbsp;&nbsp;<a href="#myprov" rel="leanModal" name="myprov" class="button_p" title="Buscar Proveedor"><img src="../img/icon/buscar_detalle.png"></a></td>
            </tr>
          <tr>
      ...
      <div class="box_1">
        ...
        <table width="100%" border="0">
          ...
          <tr>
            ...
            <td align="right"><?php echo "S/. ".$carrito->calcularValorCompra(); ?></td>
            </tr>

          <tr>
            <td sclass="txt_box">I.G.V. %: </td>
            <td align="right"><?php echo "S/. ".$carrito->calcularIgv(); ?></td>
            </tr>
          </table>
        <br>
        <div class="box_1_1">
          <table width="100%" border="0">
            <tr>
              ...
              <td class="txt_box_bottom" align="right"><?php echo "S/. ". $carrito->calcularTotalPagar(); ?></td>
              </tr>
            </table>
          </div>
      </div></td>
...
<script type="text/javascript">
function Limpiar(){
txtDato_producto.value = "";
cboCriterio_producto.value="codigo";
enviarParametrosProducto();
cboCriterio_producto.value="- Seleccione Criterio -";
...
Busqueda Por Criterio<select name="cboCriterio_proveedor" id="cboCriterio_proveedor">
  <option>- Seleccione Criterio -</option>
  <option value="nombre">Nombre o Razón Social</option>
  <option value="ruc">RUC</option>
  <option value="dni">DNI</option>
</select>
Filtro Por Detalle:<input type="text" name="txtDato_proveedor" id="txtDato_proveedor">
<input type="button" name="button" id="button" onClick="enviarParametrosProveedor()" value="Buscar">
<input  type= "reset" value="Limpiar" onClick= "enviarParametrosProducto()" onClick= "enviarParametrosProducto()" >
