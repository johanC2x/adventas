      ...
      <div class="box_1">
        ...
        <table width="100%" border="0">
          ...
          <tr>
            ...
            <td align="right"><?php echo "S/. ".$carrito->calcularValorVenta(); ?></td>
            </tr>
...
Ingresar criterio:<select name="cboCriterio_producto" id="cboCriterio_producto">
...
Filtrar por Criterio:<input type="text" name="txtDato_producto" id="txtDato_producto">
