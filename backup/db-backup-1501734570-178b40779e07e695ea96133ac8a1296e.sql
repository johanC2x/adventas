...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;nnINSERT INTO cliente VALUES("1","PUBLICO GENERAL","20477157771","47715777","Chiclayo","455630","aaa","cliente","123" ) ; nINSERT INTO cliente VALUES("2","OSWALDO PEREZ SOSA","10456365897","45636589","chancay","9976323214","","","" ) ; nnnnDROP TABLE compra;nnCREATE TABLE `compra` (
...
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;nnINSERT INTO empleado VALUES("1","Yessenia Yadira","Ipanaque Aparacana","F","1986-07-05"," prolongacion - tacna -chancay","013773722","993303412","yesseniai17@hotmail.com","46082558","2017-01-05","2500.00","ACTIVO","administrador","21232f297a57a5a743894a0e4a801fc3","1" ) ; nINSERT INTO empleado VALUES("2","Jhon","muñoz","M","1979-01-01","chancay","997672594","997672594","jhon_dmc@hotmail.com","40636446","2017-01-02","2500.00","ACTIVO","vendedor","12345678","2" ) ; nnnnDROP TABLE pedido;nnCREATE TABLE `pedido` (
